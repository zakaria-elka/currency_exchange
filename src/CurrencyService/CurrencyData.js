...
const CurrencyData=()=>{
    ...
    async function handledata(){
      ...
      let currency2=document.getElementById("currencyList2").value
      const res = await axios.get("https://v6.exchangerate-api.com/v6/7db28e522c42a2c63b2cb428/latest/"+currency)
      let value= res.data.conversion_rates[currency2]
      document.getElementById("valueres").value=value*valueRef.current.value;          
